**
* INSTAGRAM PRIVATE API HANDLER
* @author Dewa Satriani
* Credits: https://github.com/mgp25
*/
class Signatures
{
    /**
    ...
    public static function generateSignature(
        $data)
    {
        return hash_hmac('sha256', $data, IG_CONST::IG_SIG_KEY);
    }
    /**
    ...
    public static function generateSignatureForPost(
        $data)
    {
        return 'ig_sig_key_version='.IG_CONST::SIG_KEY_VERSION.'&signed_body='.self::generateSignature($data).'.'.urlencode($data);
    }
    /**
        ...
        array $exclude = [])
    {
        ...
        // Sign data.
        $result['ig_sig_key_version'] = IG_CONST::SIG_KEY_VERSION;
